...
lt_torrent_handle_t lt_session_add_torrent_with_custom_storage_upload_mode(lt_session_t session, lt_torrent_info_t info, const char* piece_cache_dir, lt_error_t* error);
